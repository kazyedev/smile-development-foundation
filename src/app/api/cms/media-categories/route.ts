...
import { insertMediaCategorySchema } from "@/lib/db/schema/mediaCategories";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate the input
    const validatedData = insertMediaCategorySchema.parse(body);
    ...
    console.error("POST /api/cms/media-categories - Error:", error);
