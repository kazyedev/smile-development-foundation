...
interface MediaCategoryFieldsProps {
  control: Control<any>;
  errors: FieldErrors<any>;
  isArabic: boolean;
}

export function MediaCategoryFields({ control, errors, isArabic }: MediaCategoryFieldsProps) {
  const t = {
    en: {
      ...
      imageAltAr: "Image Alt Text (Arabic)",
      color: "Color",
      icon: "Icon",
    ...
    ar: {
      ...
      imageAltEn: "نص بديل للصورة (إنجليزي)",
      imageAltAr: "نص بديل للصورة (عربي)",
      color: "اللون",
      icon: "الأيقونة",
      publishing: "النشر",
      isPublished: "منشور",
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <FormLabel>{text.languageSupport}</FormLabel>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                control={control}
                name="isEnglish"
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{text.imageAltEn}</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{text.imageAltAr}</FormLabel>
                  <FormControl>
                    <Input placeholder="أدخل نص بديل للصورة..." {...field} dir="rtl" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
