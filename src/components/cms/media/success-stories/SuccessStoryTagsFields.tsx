...
interface SuccessStoryTagsFieldsProps {
  form: UseFormReturn<any>;
}

export function SuccessStoryTagsFields({ form }: SuccessStoryTagsFieldsProps) {
  ...
  const text = {
    ...
    description: isArabic ? "إدارة الكلمات المفتاحية والعلامات" : "Manage keywords and tags for better search visibility",
    ...
    removeButton: isArabic ? "إزالة" : "Remove"
  };
