...
export function VideoBasicFields({ form }: VideoBasicFieldsProps) {
  ...
  const t = {
    en: {
      basicInfo: {
        ...
        description: "Essential details about the video"
      },
      fields: {
        ...
        isPublic: "Public Video",
        isPublished: "Published"
      },
      placeholders: {
        titleEn: "Enter video title in English",
        titleAr: "Enter video title in Arabic",
        descriptionEn: "Enter video description in English",
        descriptionAr: "Enter video description in Arabic",
        ...
        slugEn: "video-slug",
        slugAr: "video-slug-ar",
        locationEn: "Video location in English",
        locationAr: "Video location in Arabic"
      },
      options: {
    ...
    ar: {
      basicInfo: {
        ...
        description: "التفاصيل الأساسية حول الفيديو"
      },
      fields: {
      ...
      placeholders: {
        titleEn: "أدخل عنوان الفيديو بالإنجليزية",
        titleAr: "أدخل عنوان الفيديو بالعربية",
        descriptionEn: "أدخل وصف الفيديو بالإنجليزية",
        descriptionAr: "أدخل وصف الفيديو بالعربية",
        url: "https://example.com/video.mp4",
        width: "1920",
        height: "1080",
        ...
        slugEn: "video-slug",
        slugAr: "video-slug-ar",
        locationEn: "موقع الفيديو بالإنجليزية",
        locationAr: "موقع الفيديو بالعربية"
      },
      options: {
        noCategory: "بدون فئة"
      }
    ...
    <Card className={isArabic ? "text-right" : ""}>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <Select
            value={watch("mimeType") || "video/mp4"}
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="video/avi">video/avi</SelectItem>
              <SelectItem value="video/mov">video/mov</SelectItem>
              <SelectItem value="video/wmv">video/wmv</SelectItem>
