...
interface ReportTagsFieldsProps {
  form: UseFormReturn<any>;
}

export function ReportTagsFields({ form }: ReportTagsFieldsProps) {
  ...
  const text = {
    ...
    description: isArabic ? "إدارة الكلمات المفتاحية والعلامات للتقرير" : "Manage keywords and tags for the report",
