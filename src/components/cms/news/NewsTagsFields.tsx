...
interface NewsTagsFieldsProps {
  form: UseFormReturn<any>;
}

export function NewsTagsFields({ form }: NewsTagsFieldsProps) {
  ...
  const text = {
    ...
    description: isArabic ? "إدارة الكلمات المفتاحية والعلامات للأخبار" : "Manage keywords and tags for news articles",
