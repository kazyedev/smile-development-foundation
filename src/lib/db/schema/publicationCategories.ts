...
export const insertPublicationCategorySchema = createInsertSchema(publicationCategories, {
...
export const selectPublicationCategorySchema = createSelectSchema(publicationCategories);

export const updatePublicationCategorySchema = insertPublicationCategorySchema.partial().omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export type UpdatePublicationCategory = z.infer<typeof updatePublicationCategorySchema>;
