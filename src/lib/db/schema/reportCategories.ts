...
export const insertReportCategorySchema = createInsertSchema(reportCategories, {
...
export const selectReportCategorySchema = createSelectSchema(reportCategories);

export const updateReportCategorySchema = insertReportCategorySchema.partial().omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export type UpdateReportCategory = z.infer<typeof updateReportCategorySchema>;
